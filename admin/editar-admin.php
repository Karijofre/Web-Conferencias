<?php 
  ...
  //Parámetros de lo que quiero comprobar y de lo que quiero validar y que sea un número entero:
          ...
          <form role="form" name="guardar-registro" id="guardar-registro" method="post"  action="modelo-admin.php">
                <div class="card-body">
                  ...
                  <div class="form-group">
                     ...
                     name="nombre" placeholder="Tu nombre completo" value="<?php echo $admin["nombre"]; ?>">
                  </div>
