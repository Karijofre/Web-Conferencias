                          ...
                          <?php
                                try {
                                    ...
                                    while($cat_evento = $resultado->fetch_assoc()){ 
                                        ...
                                        <option value="<?php echo $cat_evento["id_categoria"]; ?>" selected><?php
                                                echo $cat_evento["cat_evento"];?>
                                        </option>
                                        <?php }else { ?>
                                            <option value="<?php echo $cat_evento["id_categoria"]; ?>"><?php
                                                echo $cat_evento["cat_evento"];?>
                                        </option>
                                        <?php }
                                    }
                                ...
                                try {
                                    ...
                                    while($invitados = $resultado->fetch_assoc()){ 
                                        ...
                                        <option value="<?php echo $invitados["invitado_id"]; ?>"selected>
                                            <?php
                                                echo $invitados["nombre_invitado"] . " " . $invitados["apellido_invitado"]; ?>
                                        </option>
                                        <?php }else{ ?>
